...
type RecognizedTransactionResponse struct {
	AssetPurchase        *RecognizedAssetPurchase `json:"assetPurchase,omitempty"`
...
type RecognizedTransactionResult struct {
	AssetPurchase          *RecognizedAssetPurchase `json:"asset_purchase,omitempty"`
...
// Optional untrusted AI suggestions; they never execute a ledger command.
type RecognizedAssetPurchase struct {
