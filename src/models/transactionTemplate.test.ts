...
const fixture = (at = 960) => TransactionTemplate.ofTemplate({id:'1',templateType:TemplateType.Schedule.type,name:'test',type:3,categoryId:'1',sourceAccountId:'1',destinationAccountId:'2',sourceAmount:30000,destinationAmount:30000,utcOffset:480,scheduledAt:at,tagIds:[],comment:'',scheduledFrequencyType:3,scheduledFrequency:'1'} as TransactionTemplateInfoResponse);
